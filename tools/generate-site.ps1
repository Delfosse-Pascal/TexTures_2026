...
function New-HomePage {
    ...
    [void]$html.AppendLine("<p>Accueil general des textures, vignettes et musiques du projet. Les pages ci-dessous fonctionnent en local, avec galeries, boutons musique, navigation, mode clair/sombre et liens sociaux facultatifs.</p>")
    [void]$html.AppendLine("</div>")
